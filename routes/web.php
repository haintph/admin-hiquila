...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:owner'])->group(function () {
        ...
        // Điểm danh
        Route::get('/manager/attendance', action: [AttendanceController::class, 'list'])->name('attendance.list');
    ...
    Route::middleware(['role:manager'])->group(function () {
        ...
        // Salary management
        Route::get('/salary/settings', [SalaryController::class, 'settings'])->name('salary.settings');
        Route::post('/salary/settings', [SalaryController::class, 'updateSettings'])->name('salary.updateSettings');
        Route::get('/salary/calculate', [SalaryController::class, 'calculateSalary'])->name('salary.calculate');
        Route::post('/salary/save', [SalaryController::class, 'saveSalary'])->name('salary.save');
        Route::get('/salary/history', [SalaryController::class, 'history'])->name('salary.history');
        Route::get('/salary/export/{month}/{year}', [SalaryController::class, 'exportSalary'])->name('salary.export');
