...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                @php
                    $quickSearchUrl = '/staff/reservations/search/quick';
                @endphp
                            ...
                            <tbody>
                                @foreach ($reservations as $table)
                                    <tr class="{{ $table->status == 'Đến muộn' ? 'table-warning' : '' }}">
                                        ...
                                        <td>
                                            @php
                                                $showUrl = "/staff/reservations/{$table->table_id}";
                                                $checkinUrl = "/staff/reservations/{$table->table_id}/checkin";
