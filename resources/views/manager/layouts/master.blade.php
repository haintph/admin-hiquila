        ...
        <div class="main-nav">
            ...
            <div class="scrollbar" data-simplebar>
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <!-- Quản lý nhân sự -->
                    <li class="nav-item">
                        <a class="nav-link menu-arrow" href="#sidebarHR" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="sidebarHR">
                            <span class="nav-icon">
                                <iconify-icon icon="mdi:account-group"></iconify-icon>
                            </span>
                            <span class="nav-text"> Quản lý nhân sự </span>
                        </a>
                        <div class="collapse" id="sidebarHR">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="{{ route('attendance.list') }}">Danh sách</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="sidebarSalary">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="{{ route('salary.settings') }}">Cài đặt lương</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="{{ route('salary.calculate') }}">Tính lương</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="{{ route('salary.history') }}">Lịch sử lương</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="sidebarRoles">
                            <ul class="nav sub-navbar-nav">
                                <ul class="nav sub-navbar-nav">
                                    <li class="sub-nav-item">
                                        <a class="sub-nav-link" href="{{ route('user_list') }}">List</a>
                                    </li>
                                    <li class="sub-nav-item">
