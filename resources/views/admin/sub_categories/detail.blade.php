            ...
            <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <img src="{{ asset('storage/' . $subCategory->img_subcate) }}" alt="Hình ảnh danh mục"
                ...
                <div class="p-3 bg-light mb-3 rounded">
                    <div class="row justify-content-end g-2">
                        ...
                        <div class="col-lg-2">
                            <a href="{{ route('sub_category_edit', $subCategory->id) }}"
                                class="btn btn-outline-secondary w-100">Chỉnh sửa</a>
                        </div>
                    </div>
                </div>
            </div>
