                                                    ...
                                                    @foreach ($dish->variants as $variant)
                                                        <li class="list-group-item d-flex justify-content-between align-items-center"
                                                            ...
                                                            <div class="d-flex flex-grow-1 align-items-center">
                                                                <span class="me-3 fw-bold">{{ $variant->name }}</span>
                                                                <span class="me-3">
                                                                    <i
                                                                        class="mdi mdi-tag-outline me-1"></i>{{ $variant->unit }}
                                                                </span>
                                                                <span class="me-3 text-primary fw-bold">
                                                                    {{ number_format($variant->price, 0, ',', '.') }}đ
                                                                </span>
                                                                <span class="me-3">
                                                                    <i class="mdi mdi-package-variant me-1"></i>Tồn kho:
                                                                    <span
                                                                        class="{{ $variant->stock <= 0 ? 'text-danger fw-bold' : '' }}">
                                                                        {{ $variant->stock }}
                                                                    </span>
                                                                </span>
                                                                ...
                                                                @if ($variant->is_available)
                                                                    <span class="badge bg-success me-3">
                                                                        <i class="mdi mdi-check me-1"></i>Đang bán
                                                                    </span>
                                                                @else
                                                                    <span class="badge bg-danger me-3">
                                                                        <i class="mdi mdi-close me-1"></i>Ngừng bán
                                                                    </span>
                                                                @endif
                                                            </div>
                                                            ...
                                                            <div class="d-flex gap-2">
                                                                <a href="{{ route('variants.edit', $variant->id) }}"
                                                                    ...
                                                                    data-bs-toggle="tooltip" title="Sửa biến thể">
                                                                    <iconify-icon icon="solar:pen-2-broken"
                                                                        class="align-middle fs-18"></iconify-icon>
                                                                </a>
                                                                <form onsubmit="deleteVariant(event, {{ $variant->id }})"
