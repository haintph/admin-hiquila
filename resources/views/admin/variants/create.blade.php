                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Thêm biến thể cho món: {{ $dish->name }}</h4>
                        ...
                        <form action="{{ route('variants.store') }}" method="POST">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-success">
                                    <i class="mdi mdi-check me-1"></i>Lưu biến thể
                                </button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="mdi mdi-information-outline me-2"></i>Thông tin món ăn
                        </h5>
                    </div>
                    <div class="card-body">
                                ...
                                @if($dish->variants && $dish->variants->count() > 0)
                                    <div class="mt-2">
                                        <small class="text-info">
                                            ...
                                            Đã có {{ $dish->variants->count() }} biến thể
                                        </small>
                                    </div>
                                @endif
                            </div>
