                            ...
                            @forelse($tables as $table)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @if ($table->reserved_time && $table->status == 'Đến muộn')
                                            <br><small class="text-danger">
                                                Đặt lúc {{ $table->reserved_time->format('H:i') }}
                                            </small>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end pe-3">
                                        <div class="d-flex gap-1 justify-content-end">
                                            ...
                                            <form action="{{ route('tables.destroy', $table->table_id) }}" method="POST"
                                                class="d-inline"
                                                onsubmit="return confirm('Bạn có chắc chắn muốn xóa bàn {{ $table->table_number }}?')">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="8" class="text-center py-5">
                                        <div class="text-center">
                                            <iconify-icon icon="solar:table-2-broken"
                                                class="fs-48 text-muted mb-3"></iconify-icon>
