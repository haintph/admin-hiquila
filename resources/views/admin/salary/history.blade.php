            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        ...
                        <form method="GET" action="{{ route('admin.salary.history') }}" class="d-flex gap-2 me-2">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('admin.salary.calculate') }}" class="dropdown-item">Tính lương</a>
                    ...
                    @else
                        <div class="card-body text-center py-5">
                            <div class="text-muted">
                                ...
                                <a href="{{ route('admin.salary.calculate') }}" class="btn btn-primary">
                                    Tính lương ngay
                                </a>
                            </div>
                        </div>
