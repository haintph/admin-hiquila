            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        ...
                        <form method="GET" action="{{ route('admin.salary.calculate') }}" class="d-flex gap-2 me-2">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('admin.salary.settings') }}" class="dropdown-item">Cài đặt lương</a>
                                <a href="{{ route('admin.salary.history') }}" class="dropdown-item">Lịch sử lương</a>
                    ...
                    @if(isset($results) && count($results) > 0)
                        <form action="{{ route('admin.salary.save') }}" method="POST" id="salaryForm">
                            @csrf
                    ...
                    @else
                        <div class="card-body text-center py-5">
                            <div class="text-muted">
                                ...
                                <a href="{{ route('admin.salary.settings') }}" class="btn btn-primary">
                                    Cài đặt lương trước
                                </a>
                            </div>
                        </div>
