        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('admin.salary.calculate') }}" class="dropdown-item">
                                    <i class="fas fa-calculator me-2"></i>Tính lương
                                </a>
                                <a href="{{ route('admin.salary.history') }}" class="dropdown-item">
                    ...
                    <form action="{{ route('admin.salary.updateSettings') }}" method="POST" id="salaryForm">
                        @csrf
                        <div class="card-body">
                            <div class="row g-4">
                                @php
